...
* CodeVersion: 9b5786e2f5dd958d9a18459854245c985849d9c7
* Release Date: Sat Jul 18 2020 16:43:07 GMT+0800 (China Standard Time)
...
(function (global, factory) {
  ...
  var getPersitedAndCountedAndSlientBySessionId = function getPersitedAndCountedAndSlientBySessionId(sessionId) {
    ...
    return {
      ...
      disableNotification: Boolean(sessionIdArr[4])
    };
  };
  ...
  var WebIMEngine = function () {
    ...
    _proto._handleConnectionStatus = function _handleConnectionStatus(status) {
      ...
      if (status === CONNECTION_STATUS.KICKED_OFFLINE_BY_OTHER_CLIENT) {
        this.disconnect();
      }
